...
const expCards = [
  {
    ...
    responsibilities: [
      ...
      "Optimized React components to improve page load times by 25%",
  ...
  },
  {
    ...
    responsibilities: [
      "Streamlined blog approval and publishing process, addressing backlogs and increasing marketing team efficiency by 3X.",
      "Implemented exponential backoff algorithm for third-party API calls, decreasing failure rate by up to 90%.",
      "Engineered a performant system that streamlined the sending and tracking of invites and coupon codes, significantly reducing processing time by 50%, and ultimately saving ambassadors' and the marketing team's valuable time"
    ],
  },
  {
    ...
    responsibilities: [
      "Efficiently handled text-heavy data responses by using GZIP compression, reducing size up to 70%.",
      "Enhanced data quality by implementing data cleansing procedures, resulting in a 15% reduction in errors and inconsistencies.",
      "Executed comprehensive statistical analysis on customer behavior, contributing to a 25% increase in customer satisfaction.",
    ],
  },
];
